...
public class BluetoothService {
	...
	public BluetoothService(EventBus eventBus) throws Exception {
	...
	public void sendMessage(Byte message) {
		...
		if(eventBus != null && state == STATE_CONNECTED) {
	...
	private class ConnectedThread extends Thread {
        ...
        private final HalfDuplexSerialController serialController;
	 
	    public ConnectedThread(BluetoothSocket socket, EventBus eventBus) {
	        mmSocket = socket;
            ...
            serialController = new HalfDuplexSerialController(eventBus, tmpIn, tmpOut);
