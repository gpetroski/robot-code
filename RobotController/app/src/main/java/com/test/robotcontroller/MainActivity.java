...
public class MainActivity extends Activity  implements TextToSpeech.OnInitListener {
    ...
    public void onStart() {
		...
		try {
			...
			BluetoothService.setCurrentService(new BluetoothService(eventBus));
    ...
    public void setupButtons() {	
        ...
        rightButton.setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if(event.getAction() == MotionEvent.ACTION_DOWN) {
                	sendManualMove(new MoveEvent(MoveEvent.Direction.RIGHT, MoveEvent.Speed.FULL));
                } else if (event.getAction() == MotionEvent.ACTION_UP) {
                	sendManualMove(new MoveEvent(MoveEvent.Direction.STOP, MoveEvent.Speed.FULL));
                }
                return true;
            }
        });	
        ...
        upButton.setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if(event.getAction() == MotionEvent.ACTION_DOWN) {
                	sendManualMove(new MoveEvent(MoveEvent.Direction.FORWARD, MoveEvent.Speed.FULL));
                } else if (event.getAction() == MotionEvent.ACTION_UP) {
                	sendManualMove(new MoveEvent(MoveEvent.Direction.STOP, MoveEvent.Speed.FULL));
                }
                return true;
        ...
        leftButton.setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if(event.getAction() == MotionEvent.ACTION_DOWN) {
                	sendManualMove(new MoveEvent(MoveEvent.Direction.LEFT, MoveEvent.Speed.FULL));
                } else if (event.getAction() == MotionEvent.ACTION_UP) {
                	sendManualMove(new MoveEvent(MoveEvent.Direction.STOP, MoveEvent.Speed.FULL));
                }
                return true;
        ...
        downButton.setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if(event.getAction() == MotionEvent.ACTION_DOWN) {
                	sendManualMove(new MoveEvent(MoveEvent.Direction.REVERSE, MoveEvent.Speed.FULL));
                } else if (event.getAction() == MotionEvent.ACTION_UP) {
                	sendManualMove(new MoveEvent(MoveEvent.Direction.STOP, MoveEvent.Speed.FULL));
                }
                return true;
    ...
    public void sendManualMove(MoveEvent message) {
    	if(!autoPilotController.isRunning()) {
    		if(message.getDirection() == MoveEvent.Direction.STOP) {
